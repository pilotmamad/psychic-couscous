(function() {
  ...
  MESSAGES.push({
    delay: 0,
    text: "Hi my dear Akshi..."
  });

  MESSAGES.push({
    delay: 1200,
    text: "You are such a perfection."
  });

  MESSAGES.push({
    delay: 2200,
    text: "You make my heart race all the time."
  });

  MESSAGES.push({
    delay: 3600,
    text: "Your whole existence is magaical..."
  });

  MESSAGES.push({
    delay: 5200,
    text: "I love you my dear wifey forever ❤️"
  });
